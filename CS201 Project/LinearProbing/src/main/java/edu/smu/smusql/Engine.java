...
public class Engine {
    ...
    private LinearProbingHashMap<String, Table> tables = new LinearProbingHashMap<>();
    ...
    public String create(String[] tokens) {
        ...
        tables.put(tableName, newTable); // Use LinearProbingHashMap to store the table
    ...
    public String insert(String[] tokens) {
        ...
        // Retrieve table from LinearProbingHashMap
        ...
        // Create a new row using LinearProbingHashMap
        LinearProbingHashMap<String, String> row = new LinearProbingHashMap<>();
    ...
    public String select(String[] tokens) {
        ...
        List<LinearProbingHashMap<String, String>> filteredRows = new ArrayList<>();
        if (usesFirstColumn) {
            LinearProbingHashMap<String, String> row = table.getRowByFirstColumnValue(firstColumnValue);
            if (row != null && evaluateWhereConditions(row, whereClauseConditions)) {
                filteredRows.add(row);
            }
        } else {
            for (LinearProbingHashMap<String, String> row : table.getRows().values()) {
        ...
        for (LinearProbingHashMap<String, String> row : filteredRows) {
    ...
    public String delete(String[] tokens) {
        ...
        if (usesFirstColumn) {
            ...
            for (String key : table.getRows().keySet()) {
                LinearProbingHashMap<String, String> row = table.getRows().get(key);
                if (evaluateWhereConditions(row, whereClauseConditions)) {
