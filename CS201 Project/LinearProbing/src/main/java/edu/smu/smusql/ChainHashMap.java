...
// /**
// * A hash map implemented with separate chaining using an array of unsorted
// table maps.
// */
...
// table = (UnsortedTableMap<K, V>[]) new UnsortedTableMap[capacity]; // Safe
// cast
// }
...
// /**
// * Associates key k with value v in bucket h; returns old value or null if
// new.
// */
// @Override
...
// /**
// * Removes the entry for key k from bucket h; returns the value or null if not
// found.
// */
// @Override
...
// // if (n > capacity * LOAD_FACTOR_THRESHOLD || table[bucketIndex].size() >
// MAX_BUCKET_SIZE) {
// // resize(2 * capacity - 1);
// // }
// // return answer;
